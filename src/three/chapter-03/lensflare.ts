...
export const initScene = function (): void {  
  ...
  const planeMaterial = new THREE.MeshPhongMaterial({ map: textureFlare, side: THREE.DoubleSide})
  ...
  // 镜头光晕
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  const textureFlare0 = textureLoader.load(require('@/assets/lensflare0.png'))
  // eslint-disable-next-line @typescript-eslint/no-var-requires
  const textureFlare1 = textureLoader.load(require('@/assets/lensflare3.png'))
